...
exports.getStatusCodeForMediaRetry = exports.decryptMediaRetryData = exports.decodeMediaRetryNode = exports.encryptMediaRetryRequest = exports.getWAUploadToServer = exports.downloadEncryptedContent = exports.downloadContentFromMessage = exports.getUrlFromDirectPath = exports.encryptedStream = exports.getHttpStream = exports.getStream = exports.toBuffer = exports.toReadable = exports.mediaMessageSHA256B64 = exports.generateProfilePicture = exports.encodeBase64EncodedStringForUpload = exports.extractImageThumb = exports.convertToOpusBuffer = exports.getRawMediaUploadData = exports.hkdfInfoKey = void 0;
...
// [XBATS PATCH] FFmpeg Audio Converter
const convertToOpusBuffer = async (buffer) => {
...
const encryptedStream = async (media, mediaType, { logger, saveOriginalFileIfRequired, opts } = {}) => {
    let isPtt = opts?.ptt || media?.ptt || false;
    let forceOpus = opts?.forceOpus || media?.forceOpus || false;
    const { stream, type } = await (0, exports.getStream)(media, opts);
    let finalStream = stream;
    if (mediaType === 'audio' && (isPtt || forceOpus)) {
        try {
            const buffer = await (0, exports.toBuffer)(stream);
            const opusBuffer = await (0, exports.convertToOpusBuffer)(buffer);
            finalStream = (0, exports.toReadable)(opusBuffer);
        }
        catch (err) {
            logger?.warn({ err }, 'Failed to convert to opus');
            const fallback = await (0, exports.getStream)(media, opts);
